 ...
 */
export declare function hashDocument(file: Buffer): Promise<string>;
/**
 ...
 */
export declare function hashFileStream(filePath: string): Promise<string>;
/**
 * Hash with progress reporting for large files.
 * onProgress receives bytes processed and total bytes.
 */
export declare function hashFileWithProgress(filePath: string, onProgress?: (bytesProcessed: number, totalBytes: number) => void): Promise<string>;
/**
 ...
 * @returns 64-character lowercase hex string
 */
export declare function hashBase64(base64: string): Promise<string>;
/**
 ...
 * @returns 64-character lowercase hex string
 */
export declare function hashStream(stream: any): Promise<string>;
/**
