...
import type { AnchorOptions, AnchorResult, VerifyOptions, VerificationResult, RevocationReason } from '../types';
import { BatchAnchorOptions, BatchAnchorResult } from '../anchor/batch';
/**
...
export declare class SipHeron {
    ...
    private readonly verifyCache?;
    readonly anchors: {
        revoke: (anchorId: string, options: {
            reason: RevocationReason;
            note?: string;
            supersededByAnchorId?: string;
        }) => Promise<void>;
        getVersionChain: (anchorId: string) => Promise<AnchorResult[]>;
    };
     ...
     */
    getStatus(hashOrId: string): Promise<AnchorResult>;
    /**
